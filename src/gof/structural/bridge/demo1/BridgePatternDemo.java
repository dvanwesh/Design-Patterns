 ...
 * 
 * Implementation We have a DrawAPI interface which is acting as a bridge
 * implementer and concrete classes RedCircle, GreenCircle implementing the
 * DrawAPI interface. Shape is an abstract class and will use object of DrawAPI.
...
public class BridgePatternDemo {
	public static void main(String[] args) {
		Shape redCircle = new Circle(new RedCircle(), 1, 2, 10);
		Shape greenCircle = new Circle(new GreenCircle(), 3, 4, 40);
		redCircle.draw();
		greenCircle.draw();
	}
}
